...
Route::group(['prefix'=>'back','middleware'=>'auth'], function(){
	...
	Route::get('/category_old', 'Admin\OldCategoryController@index');
	Route::get('/category_old/create', 'Admin\OldCategoryController@create');
	Route::get('/category_old/edit', 'Admin\OldCategoryController@edit');
    ...
    Route::delete('/permission/delete/{id}', ['uses'=>'Admin\PermissionController@destroy','as'=>'permission-destroy','middleware'=>'permission:Permission List|All']);
    ...
    Route::get('/category/create', ['uses'=>'Admin\CategoryController@create','as'=>'category-list','middleware'=>'permission:Category Create|All']);
    ...
    Route::put('/post/hot/news/{id}', ['uses'=>'Admin\PostController@hot_news','as'=>'post-hot_news','middleware'=>'permission:Post List|All']);
...
Route::get('/user/{id}/{name?}', function ($id,$name='ProSayed') {
