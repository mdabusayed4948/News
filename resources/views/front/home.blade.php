            ...
            <div class="col-md-7">
                    <div class="feature_article_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_date"><a href="{{ url('/author') }}/{{ $hot_news->creator->id }}">{{ $hot_news->creator->name }}</a>, {{ date('F j,Y', strtotime($hot_news->created_at)) }}</div>
            ...
            @foreach ($top_viewed as $item)
                <div class="col-md-5" style="margin-bottom: 3%">
                    <div class="feature_static_wrapper">
                        <div class="feature_article_img">
                            <img class="img-responsive" width="450" style="height: 267px" src="{{ asset('public/post') }}/{{ $item->main_image }}" alt="{{ $item->title }}">
                        </div>
                        <!-- feature_article_img -->
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_title">
                                <h1><a href="{{ url('/details') }}/{{ $item->slug }}" >{{ str_limit($item->title, 30,'...' ) }}</a></h1>
                            </div>
                            <!-- feature_article_title -->
