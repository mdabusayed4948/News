            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a href="{{ url('back/category/create') }}">Create Category</a></li>
                        @endpermission
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @permission(['Post Add','All'])
                            <a href="{{ url('back/category/create') }}" class="pull-right btn btn-dark"><i class="fa fa-plus-circle"></i> <span class="badge badge-pill badge-warning">Create</span></a>
                            @endpermission
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td width="5%">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ url('/back/category/edit/'.$row->id) }}"><button class="btn btn-warning" ><i class="fa fa-pencil" data-toggle="tooltip" title="Edit"></i></button></a>
                                                @endpermission
                                                @permission(['Post Add','All'])
