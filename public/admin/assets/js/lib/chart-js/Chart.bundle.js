...
module.exports = function(Chart) {
    ...
    var defaultConfig = {
        ...
        scales: {
            xAxes: [{
                type: 'linear', // scatter should not use a category_old axis
                position: 'bottom',
...
module.exports = function(Chart) {
    ...
    Chart.controllers.bar = Chart.DatasetController.extend({
        ...
        getRuler: function(index) {
            ...
            if (xScale.options.type === 'category_old') {
    ...
    Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
        ...
        getRuler: function(index) {
            ...
            var tickHeight;
            if (yScale.options.type === 'category_old') {
            ...
            if (options.scales) {
                items = items.concat(
                    (options.scales.xAxes || []).map(function(xAxisOptions) {
                        return {options: xAxisOptions, dtype: 'category_old'};
                    }),
            ...
            if (key === 'xAxes' || key === 'yAxes') {
                ...
                if (base.hasOwnProperty(key)) {
                    helpers.each(value, function(valueObj, index) {
                        var axisType = helpers.getValueOrDefault(valueObj.type, key === 'xAxes' ? 'category_old' : 'linear');
...
module.exports = function(Chart) {
    ...
    var helpers = Chart.helpers;
    // Default config for a category_old scale
    var defaultConfig = {
        position: 'bottom'
    };
    ...
    Chart.scaleService.registerScaleType('category_old', DatasetScale, defaultConfig);
